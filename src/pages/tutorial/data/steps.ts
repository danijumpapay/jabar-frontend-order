...
export const whatsappSteps: TutorialStep[] = [
  { id: 1, title: "Chat ke Nomor WA", desc: "Chat ke nomor WhatsApp Akang Pajak dan memberitahu nama, lalu klik menu \"Pilih Layanan\".", phoneImage: "/tutorial/mutasi/phone-step-1.png" },
  ...
  { id: 12, title: "Jemput Dokumen", desc: "Kemudian, dokumen akan dijemput dan diproses oleh Akang Pajak pada H+1 hari kerja setelah order.", phoneImage: "/tutorial/mutasi/phone-step-12.png" },
