          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-white">
              <div className="flex items-center gap-3 text-gray-900">
                <Building2 className="text-kang-pajak-blue" size={24} />
            ...
            <div className="p-6 overflow-y-auto space-y-6 text-left">
              <p className="text-sm font-bold text-gray-800 border-l-4 border-kang-pajak-blue pl-3">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">(4.) PRINT OUT EKTP AGENT Kang Pajak</p>
                  <ul className="text-sm text-gray-700 space-y-1 font-medium">
                    <li className="flex gap-2">• <span>Print out eKTP agent Kang Pajak yang distempel basah PT</span></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50">
              <button
                ...
                className="w-full bg-kang-pajak-blue text-white py-3.5 rounded-xl font-bold hover:bg-blue-700 transition-all shadow-lg active:scale-[0.98]"
              >
                Tutup
              </button>
            </div>
