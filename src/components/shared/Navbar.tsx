    ...
    <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 font-inter text-left">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button 
              ...
              className="bg-[#27AAE1] hover:bg-[#1f89b6] text-white px-6 rounded-full font-bold shadow-lg shadow-[#27AAE1]/20 transition-all active:scale-95"
            >
              Cek Order
            </Button>
            <Button 
      ...
      >
        <div className="px-4 py-6 flex flex-col gap-3">
          <Button 
            onClick={() => navigateTo('tracking')}
            className="w-full h-12 bg-[#27AAE1] hover:bg-[#1f89b6] text-white rounded-xl font-bold transition-all active:scale-[0.98]"
          >
            Cek Order
          </Button>
          <Button 
